...
import com.tuhanbao.util.db.table.data.ByteArrayValue;
import com.tuhanbao.util.db.table.data.ByteValue;
import com.tuhanbao.util.db.table.data.DataValue;
import com.tuhanbao.util.db.table.data.DoubleValue;
import com.tuhanbao.util.db.table.data.FloatValue;
import com.tuhanbao.util.db.table.data.IntValue;
import com.tuhanbao.util.db.table.data.LongValue;
import com.tuhanbao.util.db.table.data.ShortValue;
