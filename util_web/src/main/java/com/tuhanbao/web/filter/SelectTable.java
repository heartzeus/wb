...
public class SelectTable {
	...
	protected SelectTable(Table table, Selector selector) {
		this(table, table.getName());
		this.selector = selector;
	}
	
	protected SelectTable(Table table, String asName, Selector selector) {
		this(table, asName);
		this.selector = selector;
	}
	...
	private SelectTable(Table table, String asName, JoinFilter filter, SelectTable parent, JoinType joinType) {
		this(table, asName);
		this.filter = filter;
		this.parent = parent;
