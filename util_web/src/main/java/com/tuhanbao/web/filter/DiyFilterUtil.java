...
public class DiyFilterUtil {
     ...
     * @return
     */
    public static List<WebFilterItem> getItems(Selector selector) {
     ...
     * @return
     */
    public static List<WebFilterItem> getItems(Selector selector, ISpecialFilterItemHandler handler) {
